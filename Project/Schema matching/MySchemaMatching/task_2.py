...
def extract_schema_paolo(directory, name, final_schema_directory, threshold, format):
...
def schema_cluster(directory, final_schema_directory, threshold, format):
    for dirname in os.listdir(directory):
        print(dirname)
        cluster = os.path.join(directory, dirname)
        extract_schema_paolo(cluster, dirname, final_schema_directory, threshold, format)



def schema_final(directory, final_schema_directory, threshold, format):
    extract_schema_paolo(directory, "finalschema", final_schema_directory, threshold, format)
